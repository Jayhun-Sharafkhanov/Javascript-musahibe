...
20. ### How do you redirect new page in JavaScript?
    ...
    ```js
    function myFunction() {
      window.location.href = "https://jayhunsharafkhanov.herokuapp.com";
    }
    ```
    ...
    ```js
    function myFunction() {
      location.replace("https://jayhunsharafkhanov.herokuapp.com");
    }
    ```
...
25. ### How do you generate random integers?
    ...
    #### ⬆ [Yuxarıya qayıt](https://github.com/Jayhun-Sharafkhanov/Javascript-musahibe)
...
31. ### How do you create specific number of copies of a string?
    ...
    console.log(copy3); // Jayhun
    console.log(copy4); //Jayhun Jayhun Jayhun Jayhun Jayhun
    console.log(copy5); // Jayhun Jayhun (ədəd tam ədədə çevriləcək)
    ```
